...
export const I18N = {
    en: {
        ...
        banner_low_traffic: "Your data quota is running low. Please renew soon.",
        banner_low_time: "Your subscription is expiring soon. Please renew to continue.",
        banner_low_both: "Your data quota and subscription time are running low.",
        ...
        support: "Get support", renew: "Renew", download_conf: "Download .conf",
        switch_lang: "Switch language", switch_theme: "Switch theme",
        ...
        usage_alert_100: "100% used — data limit reached",
        ...
        awg_note: "Download an AmneziaWG config or copy the settings and import them into AmneziaVPN. Advanced obfuscation protects your connection.",
        sstp_note: "Configure in Windows built-in VPN (set type to SSTP) or use an SSTP client on Android and Linux.",
        gre_note: "Generic Routing Encapsulation (GRE) tunnel parameters for server and router configuration.",
        gre_client_address: "Client Tunnel IP",
        gre_server_address: "Server Tunnel IP",
        vpn_mtu: "MTU",
        vpn_ttl: "TTL",
    ...
    fa: {
        ...
        banner_low_traffic: "حجم اشتراک شما رو به پایان است. لطفاً نسبت به تمدید اقدام کنید.",
        banner_low_time: "زمان اشتراک شما رو به پایان است. لطفاً نسبت به تمدید اقدام کنید.",
        banner_low_both: "حجم و زمان اشتراک شما رو به پایان است. لطفاً نسبت به تمدید اقدام کنید.",
        ...
        support: "پشتیبانی", renew: "تمدید", download_conf: "دانلود کانفیگ",
        switch_lang: "تغییر زبان", switch_theme: "تغییر پوسته",
        ...
        usage_alert_100: "۱۰۰٪ مصرف شده — سقف حجم به پایان رسید",
        ...
        awg_note: "فایل کانفیگ AmneziaWG را دانلود یا مشخصات آن را کپی کرده و در برنامه AmneziaVPN وارد کنید. ابهام‌سازی پیشرفته از ارتباط شما محافظت می‌کند.",
        sstp_note: "این مشخصات را در VPN داخلی ویندوز (نوع اتصال SSTP) یا کلاینت‌های SSTP در اندروید و لینوکس تنظیم کنید.",
        gre_note: "مشخصات تونل GRE جهت پیکربندی اتصال نقطه به نقطه در سرورها و روترهای شبکه.",
        gre_client_address: "آی‌پی داخلی کلاینت",
        gre_server_address: "آی‌پی داخلی سرور",
        vpn_mtu: "MTU",
        vpn_ttl: "TTL",
    ...
    ru: {
        ...
        banner_low_traffic: "Лимит трафика почти исчерпан. Пожалуйста, продлите подписку.",
        banner_low_time: "Срок действия подписки скоро закончится. Пожалуйста, продлите её.",
        banner_low_both: "Трафик и срок действия подписки почти исчерпаны.",
        ...
        support: "Поддержка", renew: "Продлить", download_conf: "Скачать .conf",
        switch_lang: "Сменить язык", switch_theme: "Сменить тему",
        ...
        usage_alert_100: "Использовано 100% — лимит исчерпан",
        ...
        awg_note: "Скачайте конфигурацию AmneziaWG или скопируйте настройки и импортируйте их в AmneziaVPN. Расширенная обфускация защищает ваше соединение.",
        sstp_note: "Настройте во встроенном VPN Windows (тип SSTP) или используйте клиент SSTP на Android и Linux.",
        gre_note: "Параметры туннеля Generic Routing Encapsulation (GRE) для настройки на серверах и маршрутизаторах.",
        gre_client_address: "Внутренний IP клиента",
        gre_server_address: "Внутренний IP сервера",
        vpn_mtu: "MTU",
        vpn_ttl: "TTL",
    ...
    zh: {
        ...
        banner_low_traffic: "您的流量即将用尽。请及时续费。",
        banner_low_time: "您的订阅即将到期。请及时续费。",
        banner_low_both: "您的流量与订阅时间均即将用尽。请及时续费。",
        error_title: "出错了",
        ...
        support: "获取支持", renew: "续费", download_conf: "下载 .conf",
        switch_lang: "切换语言", switch_theme: "切换主题",
        offline_title: "您已离线",
        ...
        usage_alert_100: "已使用 100% — 流量已达上限",
        ...
        awg_note: "下载 AmneziaWG 配置文件或复制设置并导入 AmneziaVPN。高级混淆可保护您的连接。",
        sstp_note: "在 Windows 内置 VPN 中配置（类型设为 SSTP）或在 Android 与 Linux 上使用 SSTP 客户端。",
        gre_note: "用于服务器和路由器配置的通用路由封装 (GRE) 隧道参数。",
        gre_client_address: "客户端隧道 IP",
        gre_server_address: "服务端隧道 IP",
        vpn_mtu: "MTU",
        vpn_ttl: "TTL",
        usage_api: "使用数据",
        connect: "连接",
